...
import {Container, Row, Col, Spinner, Jumbotron , Table, td, thead, tr, Button} from "react-bootstrap"
        ...
        return(
            <Container style = {{display:"flex", marginTop:"20px"}}>
                <Jumbotron style = {{width:"inherit"}}>
                    <h2 style = {{marginTop:"10px", marginBottom:"20px"}}><strong>{this.state.project.title}</strong></h2>
                    ...
                    <p style = {{color:"#DF691A", marginBottom:"10px"}}>Team Members:</p>
                    <Table hover size="sm" >
                    ...
                    <Row style = {{display:"flex", justifyContent: "center", marginTop:"45px"}}>
